...
public class TeacherController {
    ...
    public ResponseEntity<ApiResponse<Teacher>> updateTeacherInfo(@RequestBody Teacher teacher) {
        ...
        try {
            ...
            logger.info("TeacherController::update, teacher information update successfully. Timestamp:{},  Registration Id:{}, Teacher ID:{}", time, registerTeacher.getRegistrationId(), registerTeacher.getTeacherAcademicId());
            return new ResponseEntity<>(response, HttpStatus.CREATED);
        } catch (AlreadyExistsException e) {
            response.setMessage(e.getMessage());
            response.setData(null);
